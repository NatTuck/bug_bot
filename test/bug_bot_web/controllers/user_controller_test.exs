defmodule BugBotWeb.UserControllerTest do
  use BugBotWeb.ConnCase

  alias BugBot.Users

  @create_attrs %{avatar_url: "some avatar_url", html_url: "some html_url", login: "some login", name: "some name", token: "some token"}
